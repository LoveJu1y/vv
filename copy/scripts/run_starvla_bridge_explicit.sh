#!/usr/bin/env bash
# ============================================================================
# Bridge-LeRobot ECOT Stage-1 Explicit CoT Training Launcher
#  - Fixed COT_MODE=explicit（显式 CoT 文本生成，不用 latent reasoning/FiLM/summary）
#  - 基于 scripts/run_starvla_bridge.sh 精简而来，避免改动原脚本
# ============================================================================
set -euo pipefail
...
RUN_ID="${RUN_ID:-bridge_explicit_cot_stage1_final}"
...
echo "============================================================================"
echo " Bridge-LeRobot ECOT Explicit CoT Training (Stage=1)"
