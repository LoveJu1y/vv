...
def get_oxe_dataset_kwargs_and_weights(
    ...
    for d_name, d_weight in filtered_mixture_spec:
        try:
            ...
            # Add dataset frame transform kwargs for filtering empty reasoning
            dataset_kwargs["dataset_frame_transform_kwargs"] = {
                "chunk_filter_fn": lambda x: x["reasoning"] != ""
            }
            
            # Add the complete configuration to the list
