...
try:
    ...
    ReasoningClient = None  # type: ignore
...
class OpenVLA(PrismaticVLM):
    def __init__(
        ...
        **kwargs,
        ...
        if self.use_async:
            if ReasoningClient is None:
                raise ImportError(
                    "ReasoningClient is required when use_async=True. "
                    "Please install the 'experiments' module or set use_async=False."
                )
