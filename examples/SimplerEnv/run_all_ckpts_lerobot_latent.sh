...
#       /share/.../bridge_lerobot_fullcot_stage_bt164/checkpoints
...
CKPT_DIR=${1:-/share/project/lvjing/starVLA/results/BridgeFinal_Action/bridge_lerobot_fullcot_stage_bt164/checkpoints}
...
CKPTS=$(ls "${CKPT_DIR}"/steps_*_pytorch_model.pt 2>/dev/null | sort)
if [[ -z "${CKPTS}" ]]; then
...
# ---------------------------------------------------------------------------
# Compute per-ckpt success summary
# ---------------------------------------------------------------------------
